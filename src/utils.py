...
class Joint():
    def __init__(self, name, x, y_1, y_2, z):
        # Joint coordinates: name, 
        #   x: x coord
        #   y_1: y coord from front cam
        #   y_2: y coord from right side cam
...
class Command():
    def __init__(self):
        self.right_shoulder = Joint('right shoulder', 0, 0, 0, 0)
        self.right_elbow = Joint('right elbow', 0, 0, 0, 0)
        self.right_wrist = Joint('right wrist', 0, 0, 0, 0)
    ...
    def printDeltas(self):
        ...
        print(
            f'Delta Y: '
            f'{self.right_elbow.y_2 - self.right_shoulder.y_2}\n'
            f'Delta Z: '
